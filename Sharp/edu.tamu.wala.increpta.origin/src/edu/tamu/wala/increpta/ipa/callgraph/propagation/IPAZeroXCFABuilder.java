...
public class IPAZeroXCFABuilder extends IPASSAPropagationCallGraphBuilder{
	...
	public IPAZeroXCFABuilder(Language l, IClassHierarchy cha, AnalysisOptions options, IAnalysisCacheView cache, ContextSelector appContextSelector,
		...
		IPAZeroXInstanceKeys zik = makeInstanceKeys(cha, options, contextInterpreter, instancePolicy);
		setInstanceKeys(zik);
	}
	 ...
	 */
	 protected IPAZeroXInstanceKeys makeInstanceKeys(IClassHierarchy cha, AnalysisOptions options,
			 SSAContextInterpreter contextInterpreter, int instancePolicy) {
		 IPAZeroXInstanceKeys zik = new IPAZeroXInstanceKeys(options, cha, contextInterpreter, instancePolicy);
		 return zik;
	 }
