 ...
 *
 */
public class kTypesensIPABuilder extends IPASSAPropagationCallGraphBuilder {

	public kTypesensIPABuilder(int n, AbstractRootMethod fakeRootMethod, AnalysisOptions options,
	    ...
	    contextSelector = new TypeContextSelector(n);//
