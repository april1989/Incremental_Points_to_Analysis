...
public abstract class IPAScopeMappingInstanceKeys implements InstanceKeyFactory{
	  ...
	  public IPAScopeMappingInstanceKeys(IPAPropagationCallGraphBuilder builder, InstanceKeyFactory basic) {
	    this.basic = basic;
